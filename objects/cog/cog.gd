...
func roll_for_level() -> void:
	...
	if signi(level_range_offset) == 1:
		if Util.floor_number > 5:
			level = custom_level_range.y + (level_range_offset * ceili(Util.floor_number * 0.2))
		else:
			level = custom_level_range.y + level_range_offset
	elif signi(level_range_offset) == -1:
		if Util.floor_number > 5:
			level = (custom_level_range.y + (level_range_offset * ceili(Util.floor_number * 0.2))) + (1 * ceili(Util.floor_number * 0.2))
		else:
...
func update_health_light():
	...
	if health_ratio >= .95:
		...
		hp_light.set_color(Color(.25, 1, 0), Color(.25, 1, .25, .5))
	elif health_ratio >= .85:
		hp_light.set_color(Color(.5, 1, 0), Color(.5, 1, .25, .5))
	elif health_ratio >= .8:
		hp_light.set_color(Color(.75, 1, 0), Color(.75, 1, .25, .5))
	elif health_ratio >= .75:
		hp_light.set_color(Color(1, 1, 0), Color(1, 1, .25, .5))
	elif health_ratio >= .7:
		hp_light.set_color(Color(1, .9, 0), Color(1, .9, .25, .5))
	elif health_ratio >= .65:
		hp_light.set_color(Color(1, .8, 0), Color(1, .8, .25, .5))
	elif health_ratio >= .6:
		hp_light.set_color(Color(1, .7, 0), Color(1, .7, .25, .5))
	elif health_ratio >= .55:
		hp_light.set_color(Color(1, .6, 0), Color(1, .6, .25, .5))
	elif health_ratio >= .5:
		hp_light.set_color(Color(1, .5, 0), Color(1, .5, .25, .5))
	elif health_ratio >= .45:
		hp_light.set_color(Color(1, .4, 0), Color(1, .4, .25, .5))
	elif health_ratio >= .4:
		hp_light.set_color(Color(1, .3, 0), Color(1, .3, .25, .5))
	elif health_ratio >= .35:
		hp_light.set_color(Color(1, .2, 0), Color(1, .25, .25, .5))
	elif health_ratio >= .3:
		hp_light.set_color(Color(1, .1, 0), Color(1, .25, .25, .5))
	elif health_ratio >= .25:
		hp_light.set_color(Color(1, 0, 0), Color(1, .25, .25, .5))
	elif health_ratio >= .2:
		hp_light.set_color(Color(.9, 0, 0), Color(.9, .25, .25, .5))
	elif health_ratio >= .15:
		hp_light.set_color(Color(.8, 0, 0), Color(.8, .25, .25, .5))
	elif health_ratio >= .1:
		hp_light.set_color(Color(.7, 0, 0), Color(.7, .25, .25, .5))
	elif health_ratio >= .05:
		hp_light.set_color(Color(.6, 0, 0), Color(.6, .25, .25, .5))
	elif health_ratio > 0.0:
		light_tween = create_tween()
		light_tween.set_loops()
		light_tween.tween_callback(hp_light.set_color.bind(Color(.6, 0, 0), Color(.6, .25, .25, .5)))
		...
		light_tween = create_tween()
		light_tween.set_loops()
		light_tween.tween_callback(hp_light.set_color.bind(Color(.5, 0, 0), Color(.5, .25, .25, .5)))
