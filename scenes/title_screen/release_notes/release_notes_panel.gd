...
static var all_releases: Array[ReleaseNote] = [
	...
	load(RELEASES_PATH + "v1.3.4.tres"),
	load(RELEASES_PATH + "v1.3.3.tres"),
	load(RELEASES_PATH + "v1.3.2.tres"),
	load(RELEASES_PATH + "v1.3.1.tres"),
	load(RELEASES_PATH + "v1.3.0.tres"),
	load(RELEASES_PATH + "v1.2.7.tres"),
	load(RELEASES_PATH + "v1.2.6.tres"),
