...
func final_boss_time_baby() -> void:
	...
	final_floor.level_range = Vector2i(ceili((0.8 * ((4) + (floori((Util.floor_number - 1.0) / 8.0) / 2.0))) * Util.floor_number) - (6.0 * floori((Util.floor_number + 5.0) / 10.0)), ceili((0.8 * ((4) + (floori((Util.floor_number - 1.0) / 8.0) / 2.0))) * Util.floor_number))
