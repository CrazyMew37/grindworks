...
const OPENER_LINES_6 := [
	...
	"Wonder if you're tryin' to find the exit?",
]
...
const OPENER_LINES_11 := [
	...
	"I'd watch out for those level spikes if I were you.",
]
...
const OPENER_LINES_41 := [
	...
	"Wonder how many cogs you've destroyed...",
...
func run_shop_exit() -> void:
	if Util.floor_number < 6:
		...
		stranger.speak(GOODBYE_LINES_6.pick_random())
	elif Util.floor_number > 10 && Util.floor_number < 21:
		stranger.speak(GOODBYE_LINES_11.pick_random())
	elif Util.floor_number > 20 && Util.floor_number < 41:
		stranger.speak(GOODBYE_LINES_21.pick_random())
	elif Util.floor_number > 40 && Util.floor_number < 81:
		stranger.speak(GOODBYE_LINES_41.pick_random())
	else:
		stranger.speak(GOODBYE_LINES_81.pick_random())
